...
# PDA
python main.py current_step=evaluate_unida_tta_models models=lead dataset_key=office transfers=all settings=pda corruption=true severity=5 corruption_type=$corruption_type tta_enabled=true tta_method=tent tta_grid_search=false grid_search_hyperparams=/home/sgw3fy/jobs/unida_tta_jobs/repos/unida_tta_codebase/config/model/tta_hyperparameters_unida_lead_tta_tent.json
# OSDA
